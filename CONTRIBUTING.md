Contributing to Netrum Core
============================

The Netrum Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Netrum Core project, and is not to be
confused with overall Netrum Network Protocol consensus changes.

Whether a pull request is merged into Netrum Core rests with the project merge
...
Patches that change Netrum consensus rules are considerably more involved than
...
Where a patch set proposes to change the Netrum consensus, it must have been
...
The project leader is the release manager for each Netrum Core release.
