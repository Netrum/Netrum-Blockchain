...
pkgdatadir = $(datadir)/netrum
pkgincludedir = $(includedir)/netrum
pkglibdir = $(libdir)/netrum
pkglibexecdir = $(libexecdir)/netrum
...
CONFIG_HEADER = $(top_builddir)/src/config/netrum-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/netrum-config.h.in \
...
ACLOCAL = ${SHELL} /home/brands/Desktop/Netrum-Blockchain/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/brands/Desktop/Netrum-Blockchain/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/brands/Desktop/Netrum-Blockchain/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/brands/Desktop/Netrum-Blockchain/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = netrum-cli
BITCOIN_DAEMON_NAME = netrumd
BITCOIN_GUI_NAME = netrum-qt
BITCOIN_TX_NAME = netrum-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/brands/Desktop/Netrum-Blockchain/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = netrum
PACKAGE_BUGREPORT = www.netrum.io
PACKAGE_NAME = Netrum Core
PACKAGE_STRING = Netrum Core 1.2.2
PACKAGE_TARNAME = netrum
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/brands/Desktop/Netrum-Blockchain
abs_srcdir = /home/brands/Desktop/Netrum-Blockchain
abs_top_builddir = /home/brands/Desktop/Netrum-Blockchain
abs_top_srcdir = /home/brands/Desktop/Netrum-Blockchain
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/brands/Desktop/Netrum-Blockchain/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_netrum_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_netrum_coverage.info test_netrum.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Netrum-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/netrum-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/netrum-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/netrum-config.h
$(top_srcdir)/src/config/netrum-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/netrum-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Netrum-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Netrum-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Netrum-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_netrum.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_netrum -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_netrum_filtered.info: test_netrum.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_netrum_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_netrum_coverage.info: baseline_filtered_combined.info test_netrum_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_netrum_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_netrum_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_netrum_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_netrum.coverage/.dirstamp:  test_netrum_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_netrum.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_netrum.coverage/ total.coverage/ $(OSX_APP)
