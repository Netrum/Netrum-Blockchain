...
RESOURCES += src/qt/netrum.qrc src/qt/netrum_locale.qrc

TRANSLATIONS += src/qt/locale/netrum_bg.ts \
                src/qt/locale/netrum_de.ts \
                src/qt/locale/netrum_en.ts \
                src/qt/locale/netrum_es.ts \
                src/qt/locale/netrum_fi.ts \
                src/qt/locale/netrum_fr.ts \
                src/qt/locale/netrum_it.ts \
                src/qt/locale/netrum_ja.ts \
                src/qt/locale/netrum_pl.ts \
                src/qt/locale/netrum_pt.ts \
                src/qt/locale/netrum_ru.ts \
                src/qt/locale/netrum_sk.ts \
                src/qt/locale/netrum_sv.ts \
                src/qt/locale/netrum_vi.ts \
                src/qt/locale/netrum_zh_CN.ts \
                src/qt/locale/netrum_zh_TW.ts
