...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Netrum Core netrum-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  netrum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded netrum transaction") + "\n" +
                               "  netrum-tx [options] -create [commands]   " + _("Create hex-encoded netrum transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded netrum transaction
