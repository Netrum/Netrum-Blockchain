...
{
public:
    /// Is the inputs associated with this public key? (and there is 500000 NTR - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of netrum.
