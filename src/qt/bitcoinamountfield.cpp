...
public:
    ...
    QSize minimumSizeHint() const
    {
        if (cachedMinimumSizeHint.isEmpty()) {
            ...
            int w = fm.width(BitcoinUnits::format(BitcoinUnits::NTR, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
...
private:
    ...
    /**
     * Parse a string into a number of base netrum units and
     * return validity.
