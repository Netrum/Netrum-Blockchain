                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Netrum Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Netrum address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and netrum: URIs)"));
...
//    tabGroup->addAction(proposalAction);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Netrum Core"), this);
    aboutAction->setStatusTip(tr("Show information about Netrum Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Netrum"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Netrum addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Netrum addresses"));
    ...
    openAction->setStatusTip(tr("Open a Netrum: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Netrum Core help message to get a list with possible Netrum command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Netrum Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Netrum network", "", count));
}
...
{
    QString strTitle = tr("Netrum Core"); // default title
