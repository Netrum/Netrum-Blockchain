...
static const int MAX_PASSNTRASE_SIZE = 1024;

/* Netrum GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Netrum"
#define QAPP_ORG_DOMAIN "netrum.org"
#define QAPP_APP_NAME_DEFAULT "Netrum-Qt"
#define QAPP_APP_NAME_TESTNET "Netrum-Qt-testnet"
