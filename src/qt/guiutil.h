...
/** Utility functions used by the Netrum Qt UI.
 */
namespace GUIUtil
{
...
// Render Netrum addresses in monospace font
...
// Parse "netrum:" URI into recipient object, return true on successful parsing
