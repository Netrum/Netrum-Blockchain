...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in netrum\n"
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zNTRsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zNTR denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zNTR denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zNTR denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zNTR denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zNTR denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zNTR denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zNTR denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zNTR denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zNTR denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "  \"value\" : x.xxx,           (numeric) The transaction value in netrum\n"
            "  \"scriptPubKey\" : {         (json object)\n"
            "     \"asm\" : \"code\",       (string) \n"
            "     \"hex\" : \"hex\",        (string) \n"
            "     \"reqSigs\" : n,          (numeric) Number of required signatures\n"
            "     \"type\" : \"pubkeyhash\", (string) The type, e.g. pubkeyhash\n"
            "     \"addresses\" : [          (array of string) array of netrum addresses\n"
            "     \"netrumaddress\"   	 	(string) netrum address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
